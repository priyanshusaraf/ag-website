...
const hardcodedCollections = {
  ...
  'harris-tweed': {
    ...
    products: [
      { id: 'ht-sliding-case', name: 'Cuero y Tweed Sliding Case', basePrice: 18333, images: ['/harris-tweed-collection/ht-3-finger-robusto.jpeg', '/iloveimg-compressed/3fingerharristweed.jpg', '/iloveimg-compressed/3fingerharristweed1.jpg', '/iloveimg-compressed/3fingerharristweed2.jpg', '/harris-tweed-collection/ht-3-finger-robusto-2.jpeg', '/harris-tweed-collection/ht-3-finger-robusto-3.jpeg', '/harris-tweed-collection/ht-3-finger-robusto-4.jpeg'], availability: 'Usually ships in 4-6 weeks', description: 'A 3-finger sliding case in authentic Harris Tweed with premium leather trim and Spanish cedar lining.' },
      { id: 'ht-limited-edition-horn-top', name: 'Cuero y Tweed Limited Edition Horn Top', basePrice: 21250, images: ['/harris-tweed-collection/ht-3-finger-limited-edition-horn-top.jpeg', '/harris-tweed-collection/ht-3-finger-limited-edition-horn-top-2.jpeg', '/harris-tweed-collection/ht-3-finger-limited-edition-horn-top-3.jpeg', '/harris-tweed-collection/ht-3-finger-limited-edition-horn-top-4.jpeg'], availability: 'Limited Edition - Ships in 4-6 weeks', description: 'A 3-finger sliding case featuring a handcrafted buffalo horn top in a glossy finish that makes each piece unique. Wrapped in authentic Harris Tweed with premium leather trim and Spanish cedar lining.' },
      { id: 'ht-3-finger-camel-bone', name: 'Cuero y Tweed 3 Finger with Camel Bone', basePrice: 23375, images: ['/iloveimg-compressed/_ Harris Tweed fabric in a grey & black herringbone _3fingerwithcamelbone.jpg', '/harris-tweed-collection/ht-3-finger-limited-edition-horn-top.jpeg'], availability: 'Limited Edition - Ships in 6-8 weeks', description: 'A unique 3-finger case topped with a hand-finished camel bone cap. Each piece is one-of-a-kind, wrapped in grey & black herringbone Harris Tweed with premium leather trim and Spanish cedar lining.' },
      { id: 'ht-torpedo', name: 'Cuero y Tweed Torpedo', basePrice: 27500, images: ['/harris-tweed-collection/ht-torpedo-1.jpeg', '/harris-tweed-collection/ht-torpedo-2.jpeg', '/harris-tweed-collection/ht-torpedo-3.jpeg', '/harris-tweed-collection/ht-torpedo-4.jpeg'], availability: 'Usually ships in 4-6 weeks', description: 'Designed specifically for torpedo-shaped cigars, this case features a tapered interior to securely cradle your torpedo vitolas. Premium leather trim with full cedar lining.' },
      { id: 'ht-pack-and-go', name: 'Cuero y Tweed Pack & Go', basePrice: 37500, images: ['/harris-tweed-collection/ht-pack-and-go-robusto-main.jpeg', '/iloveimg-compressed/5fingerpackandgoharristweed.jpg', '/iloveimg-compressed/Packandgo5fingerharristweed.jpg', '/harris-tweed-collection/ht-pack-and-go-churchill.jpeg', '/harris-tweed-collection/ht-pack-and-go-robusto-size.jpeg', '/harris-tweed-collection/ht-pack-and-go-churchill-size.jpeg', '/harris-tweed-collection/ht-pack-and-go-robusto-size-2.jpeg', '/harris-tweed-collection/ht-pack-and-go-robusto-size-3.jpeg'], availability: 'Usually ships in 4-6 weeks', description: 'The iconic Pack & Go travel humidor wrapped in genuine Harris Tweed. Available in Robusto and Churchill sizes. Features cedar-lined interior with collapsible wooden dividers and zippered closure for maximum protection on the go.' },
    ],

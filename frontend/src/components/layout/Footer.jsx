        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/products?category=Desktop Humidors" className="text-muted-foreground hover:text-primary transition-colors">
                  Desktop Humidors
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/products?category=Cabinet Humidors" className="text-muted-foreground hover:text-primary transition-colors">
                  Cabinet Humidors
                </Link>
              </li>
              <li>

export const defaultLookbookContent = {
  version: 2,
  seo: {
    title: 'Andre Garcia | Luxury Cigar Cases',
    description: 'Handcrafted luxury cigar cases — the Rolls-Royce of cigar storage.',
  },
  cta: {
  ...
  spreads: [
    {
      left: {
        sideLabel: 'ANDRE GARCIA',
        sideYear: '2003-01',
        headline: 'Started by the\nRoy brothers,\nAbhik and\nAnindya, it is\nhailed as the\nRolls-Royce of\nCigar Cases.',
        bottomImg: '/imagecompressor/bullet-cigar-founder-page.png',
        cigarImg: '/imagecompressor/bullet-cigar-founder-page.png',
      },
      right: {
        foundedLabel: 'FOUNDED IN',
        year: '2003',
        city: 'KOLKATA',
        foundersImg: '/imagecompressor/roy-brothers.png',
        foundersLabel: 'ROY BROTHERS',
      },
    },
    {
      left: {
    ...
    },
    {
      ...
      right: {
        boldText: 'Andre Garcia revolutionised the world of cigar cases with its St James Collection, Pack & Go, Manhattan, the Golf and Buffalo Horn Collection, for which Roy has a patent.',
        body1: "Andre Garcia brand's guiding principle is one size does not fit all. Roy pioneered a spectrum of sizes to accommodate anything from a short trip, for which one might like a solo smoke, to a party, at which one intends to offer cigars to all the guys.",
        body2: 'Striving for multiplicity, Andre Garcia crafted 1–, 2–, 4–, 5–, 6–, 8–, 10–, 16– and 20–finger cases in various designs, leather grains, dimensions, and colors, as well as widths and lengths.',
        textureImg: '/imagecompressor/cigar-case-fabric.png',
      },
    },
    {
      left: {
        img: '/imagecompressor/st-james-collection-cigar-case.png',
        title: 'St.\nJames\nCollection',
      },
      right: {
        boldText: 'The St. James Collection accommodates a cutter, a lighter and a humidification.',
        body: 'Perhaps the most innovative case on the market, here is a case that combined not only space for cigars, but also for accessories! The cigar section is a telescoping case with space for 6-16 cigars, depending on model, with a zip-around section on the top to keep your lighter, cutter and other accessories handy and in one place. You can choose from both smooth leather finishes, a weaved style and a crocodile-style finish, all in multiple colors.',
        productImg: '/imagecompressor/st-james-collection.png',
        textureImg: '/imagecompressor/st-james-collection-leather.png',
      },
    },
    {
      left: {
        title: 'Buffalo\nHorn\nCollection',
        caseImg: '/imagecompressor/buffalo-horn-main.png',
        cigarImg: '/imagecompressor/buffalo-horn-cigar.png',
      },
      right: {
        body1: "Here's a series of hard-leather, two or three-finger cases in a variety of finishes: smooth leather in multiple colors, woven leather, Croco or Ostrich patterns. Each sliding case can accommodate cigars of various lengths in hard-shell protection, including the most densely packed suitcase. And the top of each telescoping case has a hard, Buffalo horn top in a marvelous, glossy finish that makes each one unique.",
        productImg: '/imagecompressor/buffalo-horn-collection-main.png',
        boldText: 'The Buffalo Horn showcase multi-hued, sinewy caps made from the horny appendages of the buffalo.',
      },
    },
    {
      left: {
    ...
    },
    {
      left: {
        ...
        churchillImg: '/imagecompressor/churchill-and-short-churchill-cigar.png',
        churchillTitle: 'CHURCHILL',
        churchillBody:
      ...
      right: {
        torpedoImg: '/imagecompressor/torpedo-cigar.png',
        pigtailImg: '/imagecompressor/pigtail-cigar.png',
        shortieTitle: 'SHORTIE',
        shortieBody:
        ...
        quoteAuthor: 'ABHIK ROY',
        pigtailTitle: 'PIGTAIL',
        pigtailBody:

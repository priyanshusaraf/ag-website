...
export default function CollectionProductPage() {
  ...
  const currentProduct = collection.products.find(p => p.id === productId) || collection.products[0];
  ...
  if (!currentProduct) {
    return (
      <div className="min-h-screen bg-[#0a0a0b] flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-2 text-white">Product Not Found</h1>
          <p className="text-white/60 mb-6">This product doesn&apos;t exist in this collection.</p>
          <Button asChild>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b]">
      ...
      <div className="border-b border-white/10 bg-[#0a0a0b]">
        <div className="container mx-auto px-4 lg:px-8 py-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-white/30">&gt;</span>
            <Link href={`/collections/${slug}`} className="text-white/50 hover:text-white transition-colors">{collection.name}</Link>
            <span className="text-white/30">&gt;</span>
      ...
      {/* Product Navigation Bar - other products in this collection */}
                ...
                <Link
                  ...
                  className={`flex-shrink-0 flex items-center gap-3 px-4 py-2 rounded-lg border transition-all ${
                    product.id === productId
                      ...
                      : 'border-white/10 bg-[#0a0a0b] text-white/60 hover:border-white/30 hover:text-white'
                  }`}
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-xs font-medium truncate max-w-[160px]">{product.name}</p>
                    <p className="text-xs text-primary">{formatPrice(product.basePrice)}</p>
                  </div>
                </Link>
              ))}
            </div>
      ...
      <div className="container mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-6">
            <div>
              <Badge className="mb-3 bg-primary/20 text-primary border-primary/30 uppercase tracking-widest text-[10px]">
                {collection.name}
              </Badge>

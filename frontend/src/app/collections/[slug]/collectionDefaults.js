  ...
  'st-james': {
    ...
    products: [
      ...
      },
      {
        ...
        basePrice: 18700,
        images: ['/imagecompressor/st-james-collection.png', '/imagecompressor/st-james-collection-cigar-case.png', '/imagecompressor/st-james-collection-leather.png'],
        availability: 'Usually ships in 4-6 weeks',
      },
    ],
    ...
    products: [
      {
        ...
        availability: 'Usually ships in 4-6 weeks',
        description: 'A 3-finger sliding case in authentic Harris Tweed with premium leather trim and Spanish cedar lining. Available with a standard top or a handcrafted buffalo horn top (Limited Edition).',
      },
      {
        id: 'ht-torpedo',

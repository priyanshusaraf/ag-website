...
// Local images from the website for the about page hero carousel
const aboutHeroImages = [
  '/imagecompressor/manhattan-collection-1.png',
  '/imagecompressor/st-james-collection-cigar-case.png',
  '/imagecompressor/buffalo-horn-collection-main.png',
  '/imagecompressor/pack-and-go.png',
  '/imagecompressor/manhattan-croco-black.png',
  '/imagecompressor/carbon-fibre-collection.png',
  '/imagecompressor/manhattan-6-finger-croco-brown.png',
  '/imagecompressor/cigar-cases-preview-below-founder-page.png',
];
...
const About = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section with Local Image Carousel Background */}
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        {/* Carousel Background - Local images */}
        <div className="absolute inset-0 z-0">
          {aboutHeroImages.map((src, index) => (
            ...
            >
              <img
                src={src}
                alt={`André García collection ${index + 1}`}
        ...
        <div className="relative z-20 container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <Badge className="mb-4 bg-white/20 text-white border-white/30">Since 1985</Badge>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white drop-shadow-2xl">
              The Story Behind <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-500">André García</span>
            </h1>
              ...
              <div className="aspect-[4/5] bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg flex items-center justify-center shadow-luxury">
                <div className="text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl">André García</h3>
